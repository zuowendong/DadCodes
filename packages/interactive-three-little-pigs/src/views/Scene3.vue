      ...
      <template #step-1="{ isActive, isCompleted, onComplete }">
        <div class="space-y-8">
          ...
          >
            ...
            <TypewriterText
              v-else-if="isActive"
              text='老二想："木头比稻草结实多了，我要用木头盖一座坚固的房子！"'
              :speed="80"
              @complete="onComplete"
            />
          </div>
          ...
          <div>
            ...
            >
              ...
              >
                ...
                >
                  <span class="inline-block">
                    老二看着自己的木头房子，自豪地说："这房子比稻草房结实多了，我很安全！"
                  </span>
                </p>
              </div>
            </div>
            <TypewriterText
              v-else-if="isActive"
              text='老二看着自己的木头房子，自豪地说："这房子比稻草房结实多了，我很安全！"'
              :speed="80"
